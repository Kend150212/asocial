...
export async function GET(req: NextRequest) {
    ...
    authUrl.searchParams.set('scope', 'pages_show_list,pages_read_engagement,pages_manage_engagement,pages_manage_posts,pages_manage_metadata,pages_read_user_content')
